      ...
      <q-card style="box-shadow:none;background:transparent;">
        ...
        <q-card-section>
          ...
          <div class="row abc">
            ...
            ></q-input>
            <q-input v-model="text" filled label="Label" label-color="orange" maxlength="12" :dense="dense">
          ...
          <div class="row abc">
            <q-input
              ...
              :dense="dense"
            ></q-input>
            <q-input filled type="date" label="Label" input-class="text-right" :dense="dense"></q-input>
            <q-input filled label="Label" input-class="text-right" :dense="dense"></q-input>
          </div>
            
          <div class="row">
            <div class="col abc col-md-4 offset-md-4">
              <q-input
                filled
                type="time"
                v-model="text"
            ...
            <div class="col abc col-md-4">
              <q-input filled v-model="text" label="Label" maxlength="12" :dense="dense" readonly></q-input>
            </div>
          </div>
          <div class="row abc">
              <q-select
        ...
        <q-card-section
          ...
          ">
          <ag-grid-vue
            id="grid" style="height:100%;width:100%;zoom:110%;"
